...
- `StudentHome` — **5 tab**: Chat | Tài liệu (collection Firestore `materials`, xem `#Materials` bên dưới) | **Bài tập** (trung tâm, nút tròn nổi) | Thi & Kiểm tra (bài tập có `kind:'kiemtra'`, chọn lúc giao bài) | Kết quả
